...
def parse_opt():
    ...
    parser.add_argument('--provider', default='cuda', type=str,help='set session provider')
...
def main(opt):
    ...
    for opt.weights in (opt.weights if isinstance(opt.weights, list) else [opt.weights]):
        ...
        if opt.provider == 'cuda':
            model_log = modified_path.replace('onnx','csv') + '/cuda/model_' + last_segment +'.csv'

            time_log = modified_path.replace('onnx','csv') + '/cuda/time_' + last_segment +'.csv'

        elif opt.provider == 'cpu':
            model_log = modified_path.replace('onnx','csv') + '/cpu/model_' + last_segment +'.csv'

            time_log = modified_path.replace('onnx','csv') + '/cpu/time_' + last_segment +'.csv'
